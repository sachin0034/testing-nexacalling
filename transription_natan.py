...
client = ElevenLabs(api_key="YOUR_API_KEY") #for elevenlabs for text-to-speech
...
def reply():
    ...
    audio = client.generate(text=llm_response, voice="Bella", model='eleven_monolingual_v1')
...
if __name__ == "__main__":
    ...
    port = 5000 # 5000 does not work on mac because it is used for airdrop
